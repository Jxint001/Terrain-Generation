...
def fill(x: int, y_min: int, y_max: int, z: int, block_name: str):
    print("fill {} {} {} {} {} {} minecraft:".format(x, y_min, z, x, y_max, z) + block_name, file=f)
...
def visualize(height_array: np.ndarray, x_max: int, z_max: int):
    ...
    terrain_plot = ax.scatter(x_coords, z_coords, height_array, c=height_array, cmap='terrain', marker='.')
